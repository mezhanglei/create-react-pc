...
class DragResize extends React.Component<DragResizeProps, DragResizeState> {
  ...
  componentDidUpdate(prevProps: DragResizeProps, prevState: DragResizeState) {
    const widthChanged = this.props.width !== prevProps.width || this.props.width !== prevState?.nowStyle?.width;
    const heightChanged = this.props.height !== prevProps.height || this.props.height !== prevState?.nowStyle?.height;
